/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c09e6bfcc7735905b2a91ce18d8ee268)
// Runtime types generated with workerd@1.20260511.1 2026-05-12 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		TEST_OPENROUTER_API_KEY: string;
		LLM_RELAY: Workflow<Parameters<import("./src/index").LlmRelayWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CALLBACK_URL" | "SHARED_SECRET" | "TEST_CALLBACK_URL" | "TEST_SHARED_SECRET" | "TEST_OPENROUTER_API_KEY">> {}
}
